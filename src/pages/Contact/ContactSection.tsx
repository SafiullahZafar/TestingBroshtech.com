...
//         {/* LEFT SIDE */}
//         <div className="flex flex-col gap-10 relative md:top-9 lg:left-7 lg:w-[45vw]">
...
//           <div className="w-full lg:w-[45vw] bg-[#D9D9D9]/21 border lg:left-7 relative border-white/10 rounded-[10px] p-6 md:p-8 text-[#8B8B8B]">
...
const ContactComponent: React.FC = () => {
  ...
  return (
    <div
      className="relative min-h-screen lg:h-[880px] w-full bg-black text-[#D9D9D9] flex items-center justify-center px-4 md:px-8 py-16 overflow-hidden font-sans"
      style={{ fontFamily: 'Inter, sans-serif' }}
    >
     ...
     <div className="absolute hidden sm:block sm:top-[123px] w-full md:w-[74vw] sm:w-[74vw] flex justify-center pointer-events-none">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        {/* LEFT SIDE */}
        <div className="flex flex-col gap-10 top-10 relative md:top-2">
        ...
        {/* RIGHT SIDE */}
        <div className="w-full md:top-1 top-10 relative">
            ...
            <AnimatePresence mode="wait">
              ...
              {activeTab === 'call' && (
                ...
                >
                  ...
                  {[
                    { label: 'Corporate Office', number: '+92 41 521-8391' },
                    { label: 'Founder & CEO', number: '+92 300 366-2818' },
                    // { label: 'Technical Lead', number: '+92 321 987-6543' }
                  ].map((item) => (
                    <div
                      key={item.label}
